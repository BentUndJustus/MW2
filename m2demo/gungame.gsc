...
initGuns()
{
	...
	self.gunNameList[1] = "Beretta";
	self.gunNameList[2] = "Coltanaconda";
	self.gunNameList[3] = "Deserteagle";
	self.gunNameList[4] = "Deserteagle-Gold";	
	self.gunNameList[5] = "Deserteagle";
	self.gunNameList[6] = "PP2000";
	self.gunNameList[7] = "Tmp";
	self.gunNameList[8] = "Beretta393";
	self.gunNameList[9] = "Glock";
	...
	self.gunNameList[17] = "Uzi";
	self.gunNameList[18] = "Kriss";
	...
	self.gunNameList[26] = "M4";
	self.gunNameList[27] = "Ak-47";
	self.gunNameList[28] = "Tavor";
	self.gunNameList[29] = "F2000";
	self.gunNameList[30] = "Masada";
	self.gunNameList[31] = "SA80";
	self.gunNameList[32] = "AUG";
	self.gunNameList[33] = "Rpd";
	self.gunNameList[34] = "Mg4";
	self.gunNameList[35] = "M240";
	self.gunNameList[36] = "Wa2000";
	self.gunNameList[37] = "M21";
	self.gunNameList[38] = "Barett";
	self.gunNameList[39] = "Cheytac";
	self.gunNameList[40] = "M79";
	self.gunNameList[41] = "AT4";
	self.gunNameList[42] = "RPG";
	self.gunNameList[43] = "Semtex";
	self.gunNameList[44] = "C4";
	self.gunNameList[45] = "Concussion Grenade";
